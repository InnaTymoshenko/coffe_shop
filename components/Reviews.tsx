...
const Reviews = () => {
	...
	return (
		<div className="relative w-full lg:max-w-[960px] md:max-w-[650px] sm:max-w-[450px] h-[280px] mx-auto overflow-hidden">
			<div
				...
				{chunkedReviews.map((group, index) => (
					...
					>
						{group.map(review => (
							<div
								key={review.id}
								className="w-full max-w-[320px] h-[220px] bg-gray-900/80 text-gray-200 border-transparent rounded-sm flex flex-col items-center justify-between p-4"
							>
