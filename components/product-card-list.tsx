...
const ProductCardList = ({ item }: Props) => {
	...
	return (
		<>
			...
			<Button
				text="Add to cart"
				className="button bg-orange-600 py-2 px-4 border-2 border-orange-600 hover:border-gray-200 active:bg-orange-700 active:scale-95 transition-all duration-150"
