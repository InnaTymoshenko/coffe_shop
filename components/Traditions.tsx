		...
		<div className="w-full flex bg-gray-900 flex-col gap-8 justify-start py-8 mb-8">
			<Shell className="container flex flex-col flex-wrap gap-4 justify-center items-start">
				...
				<div className="w-full max-w-[960px] mx-auto flex flex-col items-center gap-8 justify-center relative">
					<div className="relative w-full md:h-[55vh] sm:h-[70vh] overflow-hidden">
						{traditions &&
							traditions.map((tradition, index) => (
								...
								>
									<div className="relative w-full h-[400px]">
										<div className="absolute top-0 left-[2rem] z-10 md:w-[600px] sm:w-full h-[450px] rounded-sm overflow-hidden">
											<img
												src={tradition.image}
												alt={tradition.title}
										...
										<div className="absolute md:top-[20%] sm:top-[80%] md:left-[55%] sm:left-0 z-20 w-[350px] h-[300px] flex justify-center items-center rounded-sm p-2 bg-gray-900 text-gray-200">
