...
import { cafeSchema } from '@/method/validation/cafes-shema'
			...
			<Shell>
				...
				<form onSubmit={handleSubmit(onSubmit)} className="space-y-4 p-4 max-w-xl mx-auto">
					...
					<div>
						...
						<input {...register('managerName')} className="w-full border p-2 rounded" />
					...
					<div>
						...
						<input {...register('managerEmail')} className="w-full border p-2 rounded" />
					...
					<div>
						...
						<input {...register('openingHours')} className="w-full border p-2 rounded" />
					</div>
